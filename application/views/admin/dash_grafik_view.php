...
<body class="sb-nav-fixed">
            ...
            <main>
                ...
                <div class="card mb-4">
                        <div class="card-header">
                            <a class="btn btn-primary" href="<?php echo site_url('admin/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                        </div>
                        <div class="card-body">
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Barang', 'Device'],
                datasets: [{
                    label: '# Barang',
                    data: [<?php echo $barang; ?>, <?php echo $device; ?>],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)'
                    ],
            ...
            options: {
                plugins: {
                    title: {
                        display: true,
                        text: 'Grafik Jumlah Barang/Alat Universitas Garuda'
                    }
                },
                scales: {
                    yAxes: [{
        ...
        var myChartt = new Chart(ctx, {
            ...
            options: {
                plugins: {
                    title: {
                        display: true,
                        text: 'Grafik Perbandingan Jumlah Alat/Barang di Universitas Garuda'
                    }
                },
